  ...
  return (
      ...
      {/* dashboard heading */}
        ...
        <div className="mb-5 w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* card compenent */}
            <div className="bg-white outline-0 border border-gray-200 rounded-xl shadow-xs  px-4 py-5 h-30 flex justify-between slide-in-from-bottom duration-300">
        ...
        <div className='w-full flex flex-col lg:flex-row items-start lg:gap-x-4 gap-y-4 '>
            ...
            <div   className='w-full lg:w-[67%] h-auto  overflow-x-scroll md:overflow-x-hidden bg-white border border-gray-200 rounded-xl shadow-xs slide-in-from-bottom  duration-800'>
            ...
            {/* ------------------------- */}
            {/* Request Statuses */}
             <div className='w-full lg:w-[33%] h-auto lg:h-88  px-4 py-5 bg-white outline-0 border border-gray-200 rounded-xl shadow-xs slide-in-from-bottom duration-1000'>
                {/* header */}
