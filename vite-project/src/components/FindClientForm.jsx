    ...
    <div className='flex flex-col gap-y-5'>
        ...
        <form className='w-full h-auto grid grid-cols-2 gap-x-3 gap-y-4'>
            <div className='flex flex-col justify-center items-start gap-y-2 col-span-2'>
                ...
                <input type="text" name="" id="" placeholder='e.g. CLT-001' className=' outline-none border border-gray-200 focus:outline-none  focus:border-2 focus:border-blue-500 focus:duration-50 focus:ease-in-out rounded-xl  py-2.5 px-3  text-sm text-gray-900 w-full'/>
            ...
            <div className='flex flex-col justify-center items-start gap-y-2 col-span-2'>
                ...
                <input type="text" name="" id="" placeholder='e.g. alice@gmail.com' className=' outline-none border border-gray-200 focus:outline-none  focus:border-2 focus:border-blue-500 focus:duration-50 focus:ease-in-out rounded-xl  py-2.5 px-3  text-sm text-gray-900 w-full'/>


            </div>
             <div className='flex items-center justify-end  gap-x-3 col-span-2'>
